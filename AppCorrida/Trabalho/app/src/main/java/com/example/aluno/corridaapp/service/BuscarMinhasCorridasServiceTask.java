...
public class BuscarMinhasCorridasServiceTask extends AsyncTask<Void, Void,List<CorridaResponse>> {
    @Override
    protected List<CorridaResponse> doInBackground(Void... code) {
        URL url = null;

        try {
            url = new URL("https://api.davesmartins.com.br/api/corridas");
