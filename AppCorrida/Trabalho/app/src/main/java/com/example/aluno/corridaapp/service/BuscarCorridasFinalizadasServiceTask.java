...
public class BuscarCorridasFinalizadasServiceTask extends AsyncTask<String,Void,List<CorridaResponse>> {
    @Override
    protected List<CorridaResponse> doInBackground(String... code) {
        URL url = null;

        try {
            url = new URL("https://api.davesmartins.com.br/api/corridas/fechadas");
